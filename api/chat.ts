// Vercel Serverless Function — Claude proxy for streaming chat.
// Streams SSE from Anthropic back to the client. Rate-limited per IP.
//
...
const RATE_MAX = 30; // chat is chattier than reports
