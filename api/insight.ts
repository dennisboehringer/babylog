// Vercel Serverless Function — Claude proxy for the daily "Did you know"
// observation on the Chat tab. Same envelope as /api/report (non-streaming),
// with a tighter per-IP rate limit since the client caches the result per day.
//
...
const RATE_MAX = 5; // client caches one per day per baby; even with 3 babies + refresh this is plenty
